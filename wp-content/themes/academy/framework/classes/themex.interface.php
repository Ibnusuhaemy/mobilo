...
class ThemexInterface {
	...
	public static function renderCommentForm($fields) {
		...
		if(is_singular('lesson')) {
			$default['comment_field']='<div class="formatted-form"><div class="field-wrapper"><input id="title" name="title" type="text" placeholder="'.__('Topik Pertanyaan', 'academy').'" /></div>';
			$default['comment_field'].='<div class="field-wrapper"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__('Isi Pertanyaan', 'academy').'"></textarea></div></div>';
			$default['comment_notes_before']='';
			$default['comment_notes_after']='';
			$default['logged_in_as']='';
			$default['label_submit']=__('Tambahkan Pertanyaan', 'academy');
		} else {
			...
			$default['fields']['url']='';
			$default['comment_field']='<div class="field-wrapper"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__('Komentar', 'academy').'"></textarea></div>';
			$default['label_submit']=__('Tambahkan Komentar', 'academy');
		}	
