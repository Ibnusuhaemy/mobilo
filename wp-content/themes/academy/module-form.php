<form action="<?php echo themex_url(true, ThemexCore::getURL('register')); ?>" method="POST">
	...
	<a href="#" class="button medium submit-button left"><?php _e('Mulai Pelajari', 'academy'); ?></a>
	...
	<?php } else if(!ThemexCourse::isMember()) { ?>
		...
		<a href="#" class="button medium price-button submit-button left tombolmerah">	
	...
	<?php } else { ?>
		...
		<a href="#" class="button secondary medium submit-button left tombolhijau"><span class="button-icon check"></span><?php _e('Dipelajari', 'academy'); ?></a>
