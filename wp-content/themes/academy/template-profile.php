...
<div class="fourcol column">
	...
	<center>
	<div class="bordered-image thick-border roundedimage">
	...
	<div class="user-image-uploader">
		<form action="<?php echo themex_url(); ?>" enctype="multipart/form-data" method="POST">
			<label for="avatar" class="button tombolmerah"><?php _e('Upload Foto','academy'); ?></label>
	...
	<form action="<?php echo themex_url(); ?>" class="formatted-form" method="POST">
		...
		<!-- <div class="sixcol column"> -->
			<!-- <div class="field-wrapper"> -->
				<input type="text" name="first_name" size="30" value="<?php echo ThemexUser::$data['user']['profile']['first_name']; ?>" placeholder="<?php _e('Nama Awal','academy'); ?>">
			<!-- </div> -->
		<!-- </div> -->
		<!-- <div class="sixcol column last"> -->
			<!-- <div class="field-wrapper"> -->
				<input type="text" name="last_name" size="30" value="<?php echo ThemexUser::$data['user']['profile']['last_name']; ?>" placeholder="<?php _e('Nama Akhir','academy'); ?>" />
			<!-- </div> -->
		<!-- </div>				 -->
		...
		<div class="clear"></div>
		<?php } ?>
		<a href="#" class="button submit-button tombolmerah"><?php _e('Simpan Perubahan','academy'); ?></a>
